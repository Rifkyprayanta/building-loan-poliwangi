...
<br>
<br>
<a href="<?php echo base_url('ruangan/statusRuanganGCL1/')?>" class="btn btn-success">Lantai 1</a> <a href="<?php echo base_url('ruangan/statusRuanganGCL2/')?>" class="btn btn-success">Lantai 2</a> <a href="<?php echo base_url('ruangan/statusRuanganGCL3/')?>" class="btn btn-success">Lantai 3</a> <a href="<?php echo base_url('ruangan/statusRuanganGCL4/')?>" class="btn btn-success">Lantai 4</a>
<div class="row">
  <div class="col-sm-2">
    <br>
    ...
    { 
      ...
      if($a->id_status == 1)
        { ?>
          ...
          <td>
          <div class="col-sm-2">
            <a href="<?php echo base_url('ruangan/ketstatusRuanganGCL2/'.$simpan);?>">
              <div class="panel panel-success">
              <div class="panel-heading">
