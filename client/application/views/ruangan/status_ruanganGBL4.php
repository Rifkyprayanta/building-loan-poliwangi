...
<br>
<br>
<a href="<?php echo base_url('ruangan/statusRuanganGBL1/')?>" class="btn btn-success">Lantai 1</a> <a href="<?php echo base_url('ruangan/statusRuanganGBL2/')?>" class="btn btn-success">Lantai 2</a> <a href="<?php echo base_url('ruangan/statusRuanganGBL3/')?>" class="btn btn-success">Lantai 3</a> <a href="<?php echo base_url('ruangan/statusRuanganGBL4/')?>" class="btn btn-success">Lantai 4</a> <a href="<?php echo base_url('ruangan/statusRuanganGBL5/')?>" class="btn btn-success">Lantai 5</a>
<div class="row">
  <div class="col-sm-2">
    <br>
    ...
    { 
      ...
      if($a->id_status == 1)
        { ?>
          ...
          <td>
          <div class="col-sm-2">
            <a href="<?php echo base_url('ruangan/ketstatusRuanganGBL4/'.$simpan);?>">
              <div class="panel panel-success">
              <div class="panel-heading">
